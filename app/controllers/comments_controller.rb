class CommentsController < ApplicationController
  ...
  def create
    @comment = Comment.new
    @comment.commenter_id = params.fetch("commenter_id_from_query")
    @comment.post_id = params.fetch("post_id_from_query")
    @comment.content = params.fetch("content_from_query")
